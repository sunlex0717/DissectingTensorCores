...
void compute_diff_l1_norm(float* cpu_base, float* gpu_res, int rows, int cols,double& abs_err, double&  l1_norm){
...
void compute_diff_l2_norm(float* cpu_base, float* gpu_res, int rows, int cols, double&  l2_norm){
...
void gemm_mnk_cpu(float* MatA,float* MatB,float* MatC, float* MatD, int M, int N, int K){
...
bool Mat_has_inf(float* Mat, int num_eles){
...
bool Mat_has_nan(float* Mat, int num_eles){
